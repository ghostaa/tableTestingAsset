...
dojo.declare("com.ibm.btt.dijit.GridComparer", null, {
	...
	compareNumber : function(attrs){
		...
		return function(str1, str2){
			var num1 = dojo.number.parse(str1, cons);
			if(isNaN(num1)){
				num1 = Number(str1);
			}
			var num2 = dojo.number.parse(str2, cons);
			if(isNaN(num2)){
				num2 = Number(str1);
			}
			if(num1 > num2){
	...
	compareDate : function(attrs){
		return function(str1, str2){
			...
			var _date1 = dojo.date.locale.parse(str1,option);
			var _date2 = dojo.date.locale.parse(str2,option);
...
dojo.declare("com.ibm.btt.dijit.plugins.Pagination", dojox.grid.enhanced._Plugin, {
	...
	_initParams : function(){
		...
		var fetchParam = function(paramName, defaultValue){
			return _this.option[paramName] ? _this.option[paramName]
					: (_this.grid[paramName] ? _this.grid[paramName] : defaultValue);
		};
